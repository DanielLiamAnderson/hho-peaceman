// file: test_oil_volume_discontinuous.cpp
// author: Daniel Anderson
//
// Tests the estimate on the volume of recovered oil to observe
// if there seems to be any convergence. This test uses the
// discontinuous permeability tensor.
//
...
const std::vector<std::vector<std::string>> scaled_meshes = {
  // Triangular mesh
  {"./meshes/special/triangular5x5.typ1",
   "./meshes/special/triangular10x10.typ1",
   "./meshes/special/triangular15x15.typ1",
   "./meshes/special/triangular20x20.typ1",
   "./meshes/special/triangular25x25.typ1",},
  // Square mesh
  {"./meshes/special/cart10x10.typ1",
   "./meshes/special/cart20x20.typ1",
   "./meshes/special/cart30x30.typ1",
   "./meshes/special/cart40x40.typ1",
   "./meshes/special/cart50x50.typ1",},
};
...
int main(int argc, char* argv[]) {
  ...
  // ----------------------------------------------------------------
  //              Test with discontinuous permeability
  // ----------------------------------------------------------------
  {
    ...
    T.add_test("Recovery Volume Peaceman test with discontinuous permeability", std::shared_ptr<generic_test_data>(t_data));
  }
